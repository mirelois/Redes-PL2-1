...
public class Server extends JFrame implements ActionListener, Runnable {
    ...
    static int FRAME_PERIOD = 150; //Frame period of the video to stream, in ms
        ...
        try {
            for (String string : providedStreams) {
                while(true){
                    ...
                    RTPsocket.send(new Shrimp(Packet.getCurrTime(), 0,
        ...
        public void run() {
            while(true) {
                ...
                try {
                    ...
                    //Builds an RTPpacket object containing the frame
                    Sup rtp_packet = new Sup(Packet.getCurrTime(), imagenb, seqnb,
